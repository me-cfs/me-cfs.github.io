...
Due to [low research funding](https://pubmed.ncbi.nlm.nih.gov/32568148/) we do not properly understand the biological mechanisms and there is no approved treatment. ME/CFS most commonly strikes people between the ages of 10-40, rendering them unable to work or socialise. The disease presents with a dysregulation of the immune system, which is thought to affect the brain and the mitochondria (energy production in cells). It is relatively common (1 in 100 people), and can be caused by various factors, one being a covid infection. Since the beginning of the pandemic, ME/CFS cases have doubled. 
